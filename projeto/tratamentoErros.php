...
if(isset($_SESSION['menor'])):
    echo"<p style='color:white; background-color: red; text-align: center;'> A senha deve conter pelo menos 6 caracteres.</p>";
endif;
unset($_SESSION['menor']);

//tratamento para campos em brancos
if(isset($_SESSION['branco'])):
    echo"<p style='color:white; background-color: red; text-align: center;'> Não é permitido deixar nenhum campo em branco</p>";
endif;
unset($_SESSION['branco']);

//tratamento para senhas diferentes
if(isset($_SESSION['senha_diferente'])):
    echo"<p style='color:white; background-color: red; text-align: center;'> As senhas não coincidem.</p>";
endif;
unset($_SESSION['senha_diferente']);

//tratamento para usuario já existente
if(isset($_SESSION['usuario_existe'])):
    echo"<p style='color:white; background-color: red; text-align: center;'> Erro, o usuario já existe.</p>";
endif;
